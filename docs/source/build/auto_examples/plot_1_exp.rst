...
.. "build\auto_examples\plot_1_exp.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_build_auto_examples_plot_1_exp.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_build_auto_examples_plot_1_exp.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /build/auto_examples/images/sphx_glr_plot_1_exp_001.png
         :alt: Exponential function
         :srcset: /build/auto_examples/images/sphx_glr_plot_1_exp_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /build/auto_examples/images/sphx_glr_plot_1_exp_002.png
         :alt: Negative exponential function
         :srcset: /build/auto_examples/images/sphx_glr_plot_1_exp_002.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_build_auto_examples_plot_1_exp.py:
